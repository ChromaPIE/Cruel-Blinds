...
function SMODS.current_mod.process_loc_text()
    ...
    G.localization.misc.labels.puzzled = "错乱"
    G.localization.misc.poker_hands["No Hand"] = "无牌型"
end
